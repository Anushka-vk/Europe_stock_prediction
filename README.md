# Europe Stock Forecasting Web App

## 📌 Overview
This Europe Stock Forecasting Web App allows users to analyze historical stock data of the top 20 Europe companies, perform ARIMA-based time series forecasting, and compare predicted prices with actual stock prices using Yahoo Finance (finance).

The app is built using Streamlit, Pandas, Plotly, and Statsmodels, making it interactive and visually appealing.
  
## 🚀 Features  
✅ Stock Price Analysis: Visualize historical stock prices for Europe-listed companies.  
